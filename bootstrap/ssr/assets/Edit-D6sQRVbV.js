...
var _sfc_main = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<!--[-->`);
			_push(ssrRenderComponent(unref(Head), { title: `Edit: ${__props.meeting.title}` }, null, _parent));
			_push(ssrRenderComponent(_sfc_main$1, null, {
				header: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div${_scopeId}><h1 class="text-xl font-semibold text-warm-900 font-display"${_scopeId}>Edit Meeting</h1><p class="text-sm text-warm-500 mt-0.5"${_scopeId}>${ssrInterpolate(__props.meeting.title)}</p></div></div>`);
						...
						_: 1
					}, 8, ["href"]), createVNode("div", null, [createVNode("h1", { class: "text-xl font-semibold text-warm-900 font-display" }, "Edit Meeting"), createVNode("p", { class: "text-sm text-warm-500 mt-0.5" }, toDisplayString(__props.meeting.title), 1)])])];
				}),
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						createVNode("div", null, [createVNode("label", { class: "block text-xs font-semibold text-warm-700 mb-1.5" }, "Activity (optional)"), withDirectives(createVNode("select", {
						...
						createVNode("div", null, [createVNode("label", { class: "block text-xs font-semibold text-warm-700 mb-1.5" }, "Location (optional)"), withDirectives(createVNode("input", {
						...
						createVNode("div", null, [createVNode("label", { class: "block text-xs font-semibold text-warm-700 mb-1.5" }, "Description (optional)"), withDirectives(createVNode("textarea", {
